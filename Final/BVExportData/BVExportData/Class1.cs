                   ...
                   // DataSet Ds_1 = Bill_Header.GetDataSet();
                    ...
                    if ((api.Request[api.AddPluginPrefix("fmdt")].ToString().Trim()) != null && (api.Request[api.AddPluginPrefix("todt")].ToString().Trim()) != null)
                    {
                        ...
                        CInsertQuery insert1 = api.Database.NewInsertQuery(api.Database.PluginTableName("Export_Trigger_Table"));
                            ...
                            insert1.InsertString("sETTfmDate", fromdate1);
                            insert1.InsertString("sETTtoDate", todate1);
                            insert1.Execute();
...
//-------------------------------------------------------------------------------------------------------------
        ...
        public CTable[] DatabaseSchema()
        {
            ...
            CTable Export_Trigger_Table = api.Database.NewTable(api.Database.PluginTableName("Export_Trigger_Table"));
            Export_Trigger_Table.sDesc = "Caputures Export trigger parameters Parameters";
            Export_Trigger_Table.AddAutoIncrementPrimaryKey("ixETT");
            Export_Trigger_Table.AddIntColumn("ixProject", true, 1);
            Export_Trigger_Table.AddDateColumn("sETTfmDate", true);
            Export_Trigger_Table.AddDateColumn("sETTtoDate", true);
            Export_Trigger_Table.AddVarcharColumn("sETTextra1",200, false);
            Export_Trigger_Table.AddVarcharColumn("sETTextra2",200, false);
                       
           
            return new CTable[] {Export_Trigger_Table};
        }
