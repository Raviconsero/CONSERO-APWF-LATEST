...
namespace Consero.Plugins.CGSWorkflowSettings
{
    ...
    {
        protected const string sPluginId = "CGSWorkflowSettings@conseroglobal.com";
        protected const string sEnableWorkflow = "sEnableWorkflow";

        protected string preCommitEnableWorkflow = string.Empty;
        ...
        {
            return new string[] { "CGSWorkflowSettings" };
        }
        ...
        public CDialogItem[] ProjectDisplayEdit(CProject project)
        {
            ...
            dialogItems.Add(CreateDropDownInput(project, "Enable CGSWorkflow", sEnableWorkflow, "Enable CGSWorkflow"));
        ...
        private CDialogItem CreateDropDownInput(CProject project, string sDisplay, string sId, string sInstructions)
        {
            return new CDialogItem(Forms.SelectInputString(api.AddPluginPrefix(sId),
                                               Forms.SelectOptions(new string[] { "No", "Yes","Yes with MLA" },
                                                                   GetText(project, sId),
                                                                   new string[] { "0", "1","2" })), sDisplay, sInstructions);
        }
        ...
        {
            preCommitEnableWorkflow = SetValue(Project, sEnableWorkflow);
         ...
         /*
            if ("1".Equals(preCommitEnableWorkflow))
            {
                ...
                if (hasAllIntacctDetails)
                {
                    PostXMLTransaction(Project, "vendor", preCommitIntacctUrl, preCommitIntacctSenderId, preCommitIntacctSenderPassword,
                        preCommitIntacctCompanyId, preCommitIntacctUserId, preCommitIntacctUserPassword);
        ...
        {
            CTable ProjectCGSWorkflowSettings = api.Database.NewTable(api.Database.PluginTableName("CGSWorkflowSettings"));
            ProjectCGSWorkflowSettings.sDesc = "Assigns CGSWorkflow Settings Info to Clients";
            ProjectCGSWorkflowSettings.AddAutoIncrementPrimaryKey("ixCGSWorkflowSettings");
            ProjectCGSWorkflowSettings.AddIntColumn("ixProject", true, 1);
            ProjectCGSWorkflowSettings.AddVarcharColumn(sEnableWorkflow, 1, true, "Enable CGSWorkflow", "Whether to Enable CGSWorkflow For This Client");
        /*   
        ProjectIntacctSettings.AddVarcharColumn(sIntacctUrl, 255, true, "API Url", "The Intacct Sender Id - Integrator's Id");
            ...
            return new CTable[] { ProjectCGSWorkflowSettings, 
...
/*****
        ...
        public XmlDocument PostXMLTransaction(CProject project, string sType,
            ...
            string sCompanyId, string sUserId, string sUserPassword
            )
        *****/
            /***********
        {
            ...
            MemoryStream ms = Xml(project, sType, sSenderId, sSenderPassword, sCompanyId, sUserId, sUserPassword);
        ...
        */
        ...
        private static MemoryStream Xml(CProject project, string sType,
            string sSenderId, string sSenderPwd, string sCompanyId, string sUserId, string sUserPwd)
        {
